...
<head>
    ...
    <title>PONDIT Your Virtual Mentor</title>
    <style>
        html{
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td style="text-align: center">
                                        <a href="https://pondit.com/" style="display: block;margin-bottom: 10px;">
                                            <img src="https://pondit.com/ui/frontend/img/logo.png" height="100" alt="logo"/></a>
                                        <br/>
                                    </td>
                                </tr>
                                <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
